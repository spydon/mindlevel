...
public class Tutorial {
    ...
    private void init() {
        HTML terms = new HTML(
              ...
              + "<h2>Home</h2>"
              + "<p>The home tab contains of four sections; last finished missions, news, last logins and newest users. "
              + "They should be quite self explanatory and everything except the news elements are clickable.</p> "
              + "<h2>Missions</h2>"
              + "<p>Under this tab you can see the available missions, if you click a mission you see more information about it. "
              ...
              + "<p>If you clicked a mission you can upload a finished mission and get points for it. In the future you will get "
              ...
              + "or press the picture to get a random picture. You can also press 'H' to get the keyboard navigation available. "
              ...
              + "<h2>Misc</h2> "
              + "<p>Should you have any further questions or concerns, or if you encounter difficulties while navigating "
              + "or using the site, please contact info@mindlevel.net or file a bug, abuse or "
              + "feature request at <a href=\"#report\">#report</a></p>."
              + "<p><b>Hope you have a great time here at Mindlevel! :)<b> /<a href=\"#user=spydon\">spydon</a> </p>");
