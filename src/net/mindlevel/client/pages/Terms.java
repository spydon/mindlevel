...
public class Terms extends Page {
    ...
    protected void init() {
        HTML terms = new HTML(
              ...
              + "of the content.</p>"
              + "<h2>Cookies</h2>"
              + "<p>This site uses cookies to keep you logged in and to remember your settings, by registering you accept "
              + "the possibility that your browser might store cookies connected to the site on your device.</p>"
              + "<h2>Contacts</h2> "
