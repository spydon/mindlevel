...
public class Terms {
    ...
    private void init() {
        HTML terms = new HTML(
              ...
              + "The MindLevel.net website hosts an image publication service which are equipped with "
              ...
              + "links to malicious or dangerous websites. We do retain the right to moderate any image, comment or "
              + "written content submitted to the mindlevel.net website and to remove any content we deem to "
              + "have violated our policies. "
              + "<h2>Disclaimer</h2>"
              + "<p>All of the content contained on the MindLevel.net is edited, checked, and verified for accuracy as "
              ...
              + "otherwise, subject to a copyright held by the uploader of the content. It is permissible to link "
              + "to content from this site as long as the original source is clearly stated, but the wholesale "
              + "reproduction or partial modification of content is not permitted. Exceptions are granted only if "
              + "you receive prior written consent from either MindLevel.net or the uploader of the content.</p> "
              + "<h2>Contacts</h2> "
              + "<p>Should you have any further questions, concerns, or queries about these Terms and Conditions, "
