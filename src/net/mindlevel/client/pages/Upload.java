...
import net.mindlevel.client.services.OracleServiceAsync;
...
public class Upload {
	...
	private final OracleServiceAsync oracleService = GWT
			.create(OracleService.class);
	
	private ArrayList<SuggestBox> tagList = new ArrayList<SuggestBox>();
	...
	private FlexTable getMetaDataPanel() {
		...
		uploadB.addClickHandler(new ClickHandler() {
			...
			public void onClick(ClickEvent event) {
				MetaImage metaImage = new MetaImage(filename, titleTB.getText(), locationTB.getText(), missionId,
													descriptionTA.getText(), getTags(), Mindlevel.user.getUsername(), adultCB.getValue());
	...
	private void educateOracle() {
		oracleService.getUsers(new AsyncCallback<ArrayList<String>>() {
